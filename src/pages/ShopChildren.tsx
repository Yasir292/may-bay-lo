...
export default function ShopChildren() {
  ...
  return (
    <div className="min-h-[100dvh] bg-cream">
      ...
      <div className="relative h-[360px] md:h-[440px] overflow-hidden">
        <img src="/category-children.webp" alt="Children's Collection" className="w-full h-full object-cover" />
        <div className="absolute inset-0 bg-navy/60" />
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center px-6">
          <span className="section-label text-gold mb-4">Collection</span>
          <h1 className="font-display text-display-md text-white mb-3">Children&apos;s Wear</h1>
          <p className="font-body text-body-lg text-white/80 max-w-lg">
            Smart and stylish clothing for the little ones. Quality pieces for every adventure.
          </p>
        </div>
      </div>
      ...
      <div className="max-w-container mx-auto px-6 py-6">
        <div className="flex items-center gap-2 text-[13px] font-body text-slate mb-6">
          ...
          <span>/</span>
          <Link to="/shop/children" className="hover:text-gold transition-colors">Shop</Link>
          <span>/</span>
